...
<script data-ad-client="ca-pub-4075015640243204" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>

<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-173041089-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-173041089-2');
</script>
...
<body class="bg-light">
	<div class="text-center p-5">
		...
		<h4><b>Watermark free</b> version is back again! Shorturl support is subject to change!</h4>
	...
	<div class="border m-3 mb-5" id="result">
	    <div class="text-center"><br>Bot/Scraper Development Services: <a target="_blank" href="https://xeeflix.xyz">XeeFlix.XyZ</a></div>
...
<center><div class="bg-dark text-white" style="position: fixed; bottom: 0;width: 100%;padding:15px">Developed by <a target="_blank" href="https://twitter.com/Sahibumrani">SahibUmrani</a></div>
